  ...
  return (
    ...
    <div className="wrapper footer ">
      <div className="footer__left">
        <img src="/img/sultanlogo.svg" alt="" className="footer__img" />
        ...
        <div className="input-group">
          ...
          <button className="input-group__btn">
            <img src="/img/footer-input-btn.svg" alt="" />
          </button>
        </div>
      </div>
      ...
      <div className="footer__center">
        ...
        <div className='footer__links'>
          ...
          <div className='footer__seti'>
            <img src="/img/whatsup.svg" alt="watsup" style={{marginRight: '10px'}}/>
      ...
      <div className="footer__center-last">
        ...
        <div className='footer__right'>
          ...
          <div className='footer__cards'>
            <img src="/img/visa.svg" alt="visa" style={{marginRight: '5px'}} /> 
